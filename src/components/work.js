    ...
    <div className="work">
      ...
      <ul id="work" className="work-list">
        <li>
          ...
          <a
            class="github-button"
            href="https://github.com/niklasbec/Sprint-Challenge-Authentication/fork"
            data-icon="octicon-repo-forked"
            data-size="large"
            aria-label="Fork niklasbec/Sprint-Challenge-Authentication on GitHub"
          >
            Fork
          </a>
        </li>
        <li>
          <p className="work-title">Real estate</p>
          <div className="tech-stack">
            <img
              src="https://cdn2.iconfinder.com/data/icons/designer-skills/128/code-programming-javascript-software-develop-command-language-512.png"
              alt="javascript icon"
